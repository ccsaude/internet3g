...
def toolbar(btn):
    ...
    if btn == "EXIT":
        ...
        app.setTabBg("Tabs", app.getTabbedFrameSelectedTab("Tabs"), app.colourBox())
    elif btn == "PIE-CHART":
        app.showSubWindow("Statistics")
        ...
        app.showSubWindow("DatePicker")
    elif btn == "ADDRESS-BOOK":
        app.showSubWindow("AddressBook")
    elif btn == "MAP":
        app.showSubWindow("Maps")
...
with gui("ShowCase") as app:
    ...
    app.addToolbar(["EXIT", "LOGOUT", "FILL", "PIE-CHART", "CALENDAR", "ADDRESS-BOOK", "MAP", "FULL-SCREEN"], toolbar,
                   findIcon=True)
    ...
    app.addMenuList("Tabs", ["Login", "Lists", "Properties", "Meters", "Drag'nDrop", "Calculator", "Panes", "Labels"],
                    changeTab)
    ...
    with app.tabbedFrame("Tabs"):
        ...
        with app.tab("Lists"):
            ...
            app.addListBox("Sports", ["Football", "Rugby", "Cricket", "Golf", "Cycling", "Netball", "Rounders"], 0, 2,
                           1, 4)
